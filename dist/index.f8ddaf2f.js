...
})({"6oieI":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "09d52a2ff8ddaf2f";
"use strict";
...
},{}],"kHSI7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _server = require("../server/server");
(async function() {
    const apiData = await (0, _server.getDataFromAPI)("/v2/ladd").then((data)=>{
        return data;
    });
    const chartData = apiData?.ac.slice(0, 10).map((data)=>{
        return {
            lat: data.lat.toString().substring(0, data.lat.toString().indexOf(".")),
            long: data.lon.toString().substring(0, data.lon.toString().indexOf("."))
        };
    });
    new (0, _autoDefault.default)(document.getElementById("lineChart"), {
        type: "line",
        data: {
...
},{"chart.js/auto":"d8NN9","../server/server":"hYG1M","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"hYG1M":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function getDataFromAPI(endpoint) {
    try {
        const promise = (0, _axiosDefault.default).get(`${BASE_URL}${endpoint}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6oieI","kHSI7"], "kHSI7", "parcelRequiref1b2")

//# sourceMappingURL=index.f8ddaf2f.js.map
